...
def _block_literal_fields(*arg_types):
  return [('isa', c_void_p), (
    'flags', c_int), ('reserved', c_int), ('invoke', ctypes.CFUNCTYPE(c_void_p, c_void_p, *arg_types)), ('descriptor', _block_descriptor)]
...
class WKWebView(ui.View):
  ...
  def load_url(self, url, no_cache=False, timeout=10):
    ...
    if url.startswith('file://'):
      ...
      self.webview.loadRequest_(WKWebView.NSURLRequest.requestWithURL_cachePolicy_timeoutInterval_(nsurl(url), cache_policy, timeout))
